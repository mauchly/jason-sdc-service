...
var houseNames = ['Super_Cute_Retro_Airstream']
var generateHouseNames = function () {
for (var i = 0; i < 100; i++) {
...
var sanitizedStr = str.split(' ').join('').split('-').join('')
houseNames.push(sanitizedStr)
//console.log('1')
//console.log(catchPhrase + '' + bsAdjective + ' house')
}
return houseNames
}

console.log(generateHouseNames())
console.log('2')
...
[
  ...
  'Redundant_Microchip_Sticky_house'
]
